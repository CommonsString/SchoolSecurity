  ...
  methods: {
    ...
    deleteAll(index) {
      this.$Modal.confirm({
        ...
        onOk: () => {
          this.$http.post(
            ROUTE.toReplace+'/infoSearchAndFix/batchDeleteStuInfo',
            {
    ...
    deleteGrade(index) {
      this.$Modal.confirm({
        ...
        onOk: () => {
          ...
          //   alert('111')
          this.$http.post(
            ROUTE.toReplace+'/infoSearchAndFix/deleteAllGrade',
            {
              grade: this.grade
            },
            { emulateJSON: true }
    ...
    getDatas() {
      this.$http.post(
        ROUTE.toReplace+'/infoSearchAndFix/searchStudent',//请求路径
        {
    ...
    removeStu(index) {
      ...
      this.$Modal.confirm({
        ...
        onOk: () => {
          this.$http.post(
            ROUTE.toReplace+'/infoSearchAndFix/deleteStuInfo',
            {
