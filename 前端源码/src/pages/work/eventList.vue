...
页数
 ...
 -->
    ...
    <Modal v-model="replyBoard" width="600" title="回复面板" style="position: relative">
      ...
      <Button v-if="repSub" @click="topClickReplySets">回复</Button>
      <Button v-if="!repSub" @click="subClickReplySets">回复</Button>
      <div slot="footer">
      </div>
    </Modal>
...
export default {
  ...
  methods: {
    ...
    asyncOK() {
      this.$http.post(
          ROUTE.toReplace+'/workOfEvent/querenEvent', {
    ...
    searchReply() {
      this.replyList = []
      this.$http.post(
          ROUTE.toReplace+'/workOfEvent/searchReply', {
            eveId: this.eventId
          }, {
            emulateJSON: true
          }
    ...
    show() {
      this.$http.post(
          ROUTE.toReplace+'/workOfEvent/getOneEvent', {
            eveId: this.eventId
          }, {
            emulateJSON: true
          }
    ...
    asyncOKe() {
      this.$http.post(
          ROUTE.toReplace+'/workOfEvent/seeEvent', {
            eventId: this.eventId
          }, {
            emulateJSON: true
          }
    ...
    asyncOKshangbao() {
      this.$http.post(
          ROUTE.toReplace+'/workOfEvent/passOnEvent', {
    ...
    getEvent() {
      this.$http.post(
          ROUTE.toReplace+'/workOfEvent/getEvent', {
            page: this.page,
            uId: this.userInfo.uId
          }, {
            emulateJSON: true
    ...
    getOwnEvent() {
      this.$http.post(
          ROUTE.toReplace+'/workOfEvent/getOwnSubEvent', {
            page: this.page,
            uId: this.userInfo.uId
          }, {
            emulateJSON: true
        ...
        .then(function(res) {
          ...
          this.total3 = parseInt(res.data.total)
        })
        .catch(function(err) {
          this.$Message.error('系统连接失败!' + err)
        });
    ...
    topClickReply() {
      this.$http.post(
          ROUTE.toReplace+'/workOfEvent/topClickReply', {
            eveId: this.eventId,
    ...
    subClickReply() {
      this.$http.post(
          ROUTE.toReplace+'/workOfEvent/subClickReply', {
            eveId: this.eventId,
          }, {
            emulateJSON: true
          }
    ...
    repToTopUser() {
      this.$http.post(
          ROUTE.toReplace+'/workOfEvent/repToTopUser', {
            eveId: this.eventId,
    ...
    repToSubUser() {
      this.$http.post(
          ROUTE.toReplace+'/workOfEvent/repToSubUser', {
            eveId: this.eventId,
            repContext: this.repContext,
    ...
    chaxun() {
      this.$http.post(
          ROUTE.toReplace+'/workOfEvent/searchForUser', {
    ...
    chaxun2() {
      this.$http.post(
          ROUTE.toReplace+'/workOfEvent/searchOwnSubEvent', {
        ...
        .then(function(res) {
          ...
          this.total4 = parseInt(res.data.total)
