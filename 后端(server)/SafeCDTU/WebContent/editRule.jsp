...
<html>
	...
	<c:if test="${msg!=null }">
		<script type="text/javascript">
			...
			<article>
			<div class="Edit">
			<form action="infoSearchAndFix/editRule" method="post"> 
				<div class="Edit_Table">
					<div class="Edit_Title_Box">
					<%-- <div class="border-input">
						<input name="title" class="Edit_Title" type="text" placeholder="请在此处输入标题" value="${context.title }"/>
					</div> --%>
				  <div class="border-btn">
					...
					<input type="text" value="<%=request.getParameter("FSEdfsfKfsefseFGfsfNESGfsefNfseFEJS") %>" name="FSEdfsfKfsefseFGfsfNESGfsefNfseFEJS"/>
					<input type="text" value="<%=request.getParameter("FSEdawdaKdwadFHNSdawdEUdawHF")%>" name="FSEdawdaKdwadFHNSdawdEUdawHF"/>
					<%-- <input type="text" value="<%=request.getParameter("allSee")%>" name="allSee"/> --%>
					</div>
