...
<html>
	...
	<c:if test="${msg!=null }">
		<script type="text/javascript">
			...
			<article>
			<div class="Edit">
			<form action="context/uploadArtical" method="post"> 
				...
				<!--needConfig  JDAIKSSINHD768jghhg9njdsbc89-->	
				<input type="text" value="<%=request.getParameter("JDAIKSSINHD768jghhg9njdsbc89") %>" name="JDAIKSSINHD768jghhg9njdsbc89"><%=request.getParameter("JDAIKSSINHD768jghhg9njdsbc89") %></input>
