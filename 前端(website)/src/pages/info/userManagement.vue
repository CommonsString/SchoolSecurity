...
export default {
  ...
  methods: {
    ...
    resetPassword(index) {
      this.$http.post(
        ROUTE.toReplace+'/infoSearchAndFix/resetPassword',
        {
          // uId: ''
    ...
    offLine(index) {
      this.$Modal.confirm({
        ...
        onOk: () => {
          this.$http.post(
            ROUTE.toReplace+'/infoSearchAndFix/offLine',
            {
              // uId: ''
              uId: this.datas[index].uId
            },
    ...
    removeUser(index) {
      this.$Modal.confirm({
        ...
        onOk: () => {
          this.$http.post(
            ROUTE.toReplace+'/infoSearchAndFix/removeUser',
            {
              uId: this.datas[index].uId
            },
            { emulateJSON: true }
    ...
    resetDepartment(index) {
      this.$http.post(
        ROUTE.toReplace+'/infoSearchAndFix/resetUserDepId',
        {
          // uId: ''
          uId: this.datas[index].uId
        },
    ...
    getDates() {
      this.$http.post(
        ROUTE.toReplace+'/infoSearchAndFix/searchUser',
        {
