...
export default {
  ...
  methods: {
    ...
    success() {
      this.$http.post(
          ROUTE.toReplace+'/infoSearchAndFix/alterBasicInfo', {
            uId: this.userInfo.uId,
            name: this.name,
            tel: this.tel,
            email: this.email,
    ...
    asyncOKp() {
      if(this.xiugai1&&this.xiugai2){
        this.$http.post(
          ROUTE.toReplace+'/infoSearchAndFix/changePassword', {
            uId: this.userInfo.uId,
    ...
    getAllDep() {
      this.$http.post(
          ROUTE.toReplace+'/infoSearchAndFix/getAllDep', {
            uId: this.userInfo.uId
          }, {
            emulateJSON: true
          }
    ...
    jinru() {
      this.$http.post(
          ROUTE.toReplace+'/infoSearchAndFix/getOwnInfo', {
            uId: this.userInfo.uId
          }, {
            emulateJSON: true
          }
